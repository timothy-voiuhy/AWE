...
Documents have the shape:
    {host, path, method, status_code, tool_source, timestamp,
     request:  {method, url, headers, body},
     response: {status_code, reason, http_version, headers, body}}

`tool_source` is None for traffic passively observed from a real
client/browser, or a short tag (e.g. "graphql", "websocket") when the
request was generated by one of AWE's own testing panels — see
proxy._markers.
